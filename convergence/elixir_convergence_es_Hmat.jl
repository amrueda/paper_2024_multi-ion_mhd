...
function initial_condition_manufactured_solution(x, t, equations::IdealGlmMhdMultiIonEquations2D)
    ...
    return SVector{nvariables(equations), real(equations)}([u11, u12, u13, u1, u2, u3, u4, u5, u6, u7, u8, u9, u10, 0])
end
...
function source_terms_manufactured_solution_pe(u, x, t, equations::IdealGlmMhdMultiIonEquations2D)
    ...
    s4 = hx / 25
    s5 = (1835811702576186755 * hx * h1^2 + 8592627463681183181 * hx * h1 + 9884050459977240490 * hx) / (652252660543767500 * h1 + 1397684272593787500)
    s6 = (3 * hx) / 5
