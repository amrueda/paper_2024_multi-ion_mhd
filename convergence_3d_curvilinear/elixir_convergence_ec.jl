...
function initial_condition_manufactured_solution(x, t, equations::IdealGlmMhdMultiIonEquations3D)
    ...
    return SVector{nvariables(equations), real(equations)}([B1, B2, B3, rho_1, rhou_1, rhov_1, rhow_1, rhoe_1, rho_2, rhou_2, rhov_2, rhow_2, rhoe_2, zero(eltype(x))])
end
...
function source_terms_manufactured_solution_pe(u, x, t, equations::IdealGlmMhdMultiIonEquations3D)
    ...
    s = SVector{nvariables(equations), real(equations)}([s11, s12, s13, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, zero(eltype(u))])
